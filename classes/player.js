...
export default class Player extends ObjectBaseLifeBand {
	...
	static MATTER = {
		friction: SG2D.TileBody.MATTER.FRICTION,
		frictionAir: SG2D.TileBody.MATTER.FRICTIONAIR,
		restitution: SG2D.TileBody.MATTER.RESTITUTION,
		slop: SG2D.TileBody.MATTER.SLOP
	};
